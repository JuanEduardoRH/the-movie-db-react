...
export const Card = ({ path, className = '', footer = null, onClick, onMouseEnter }) => {
    return (
        <div
            onMouseEnter={onMouseEnter}
            onClick={onClick}
            className={`group/overlay rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:z-10 cursor-pointer shadow-lg shadow-black/25 relative ${className}`}>
